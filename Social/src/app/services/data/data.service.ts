...
export class DataService {
  ...
  location: Locations[]=[
    { id:1, address:'Your Address' },
    { id:2, address:'Your Address' },
    { id:3, address:'Your Address' },
    { id:4, address:'Your Address' },
    { id:5, address:'Your Address' },
    { id:6, address:'Carnival Cinemas.Rave 3 Mall, Rawatpur' },
    { id:6, address:'Miraj Cinemas, Gurdev, Lakhanpur' },
    { id:6, address:'CineMax ,South X Mall,Kidwai Nagar' },
    { id:7, address:'The Yacht Club,Allenganj,Swaroop Nagar' },
    { id:7, address:'Forest 91 Club, NH 91 Bypass ' },
    { id:7, address:'Offline Cafe,Khalasi Lines,Tilak Nagar' },
    { id:8, address:'Kargil Park,Motijheel,Colonelganj' },
    { id:8, address:'Sudhanshu Ashram,Bithoor' },
    { id:8, address:'Blue World Theme Park,Bithoor Road' },
